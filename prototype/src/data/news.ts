...
export const news: NewsArticle[] = [
  ...
  },
  {
    id: 'n4',
    title_zh: 'AC 赛事即将上线',
    title_en: 'AC Events Coming Soon',
    content_zh: '随着Assetto Corsa Evo的发布，Racing Arcade 将在5月开始举办AC相关赛事。敬请期待！',
    content_en: 'With the release of Assetto Corsa Evo, Racing Arcade will begin hosting AC events starting in May. Stay tuned!',
    coverImage: '',
    category: 'event',
    regions: ['CN', 'AP', 'AM', 'EU'],
    isPinned: false,
