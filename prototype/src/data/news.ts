...
export const news: NewsArticle[] = [
  {
    ...
    content_zh: 'MOZA Racing 宣布2026赛季GT3挑战赛正式启动！本赛季将横跨全球四个区域，共5站比赛。首站将于4月20日在意大利蒙扎举行。欢迎所有MOZA用户及模拟赛车爱好者报名参加！\n\n本赛季亮点：\n- 全新积分系统\n- 多Split自动分组\n- 赛事直播覆盖\n- 丰厚奖品',
    content_en: 'MOZA Racing announces the launch of the 2026 GT3 Challenge! This season spans all four regions with 5 rounds. The opener takes place at Monza, Italy on April 20th. All MOZA users and sim racing enthusiasts are welcome!\n\nSeason Highlights:\n- New points system\n- Multi-Split auto assignment\n- Live stream coverage\n- Great prizes',
    coverImage: '',
    category: 'event',
    regions: ['CN', 'AP', 'AM', 'EU'],
    isPinned: true,
  ...
  },
  {
    ...
    content_zh: '在昨晚结束的欧非区LMP2锦标赛斯帕站中，SilverArrow以出色的表现夺得冠军。比赛在动态天气条件下进行，多位车手展现了精湛的雨战技巧。\n\n最终成绩：\n1. SilverArrow - 1:28:15.234\n2. DriftKing - +17.657\n3. StormChaser - +46.333',
    content_en: 'SilverArrow took a dominant victory in last night\'s EU LMP2 Championship at Spa. The race featured dynamic weather conditions with several drivers showcasing superb wet-weather skills.\n\nFinal Results:\n1. SilverArrow - 1:28:15.234\n2. DriftKing - +17.657\n3. StormChaser - +46.333',
    coverImage: '',
    category: 'review',
    regions: ['EU'],
    isPinned: false,
