...
export const championships: Championship[] = [
  ...
  },
  {
    ...
    description_zh: '亚太区耐力系列赛，专注于长时间耐力赛的赛事系列。共3站，考验车手的持久力和策略。',
    description_en: 'The AP Endurance Series, focusing on long-distance endurance races. 3 rounds testing driver stamina and strategy.',
    coverImage: '',
    regions: ['AP', 'CN'],
    game: 'ACC',
    carClass: 'GT3',
    ...
    progressionRules_zh: '3站总积分最高者获得系列赛冠军',
    progressionRules_en: 'Highest total points across 3 rounds wins the series.',
    rules_zh: '1. 必须进站至少1次\n2. 进站窗口为赛程30%-70%\n3. 禁止使用TC大于3',
  ...
  },
  {
    id: 'ch3',
    name_zh: '欧非区GT3锦标赛',
    name_en: 'EU GT3 Championship',
    description_zh: '欧非区GT3原型车锦标赛，3站激烈角逐，在经典欧洲赛道上体验原型车竞速。',
    description_en: 'EU GT3 Prototype Championship, 3 thrilling rounds on classic European circuits.',
    coverImage: '',
    regions: ['EU'],
    game: 'LMU',
    carClass: 'GT3',
  ...
  },
  {
    id: 'ch4',
    name_zh: '中国区冲刺杯',
    name_en: 'CN Sprint Cup',
    description_zh: '中国区GT4冲刺杯赛，短距离高速竞速，2站比赛决出冠军。',
    description_en: 'CN GT4 Sprint Cup, short-distance high-speed racing. 2 rounds to crown the champion.',
    coverImage: '',
    regions: ['CN'],
    game: 'ACC',
    carClass: 'GT4',
    ...
    scoringRules_zh: '第1名25分，第2名18分，第3名15分，第4名12分，第5名10分，第6名8分，第7名6分，第8名4分，第9名2分，第10名1分',
    scoringRules_en: '1st 25pts, 2nd 18pts, 3rd 15pts, 4th 12pts, 5th 10pts, 6th 8pts, 7th 6pts, 8th 4pts, 9th 2pts, 10th 1pt',
    rules_zh: '1. 仅限CN区域车手参加\n2. 使用GT4车型\n3. 禁止TC和ABS辅助',
    rules_en: '1. CN region drivers only\n2. GT4 cars only\n3. TC and ABS assists prohibited',
  ...
  },
  {
    ...
    description_zh: '面向所有区域新手车手的Formula赛事，2站比赛，入门级方程式赛车体验。',
    description_en: 'Formula racing for rookie drivers across all regions. 2 rounds of entry-level open-wheel racing.',
    coverImage: '',
    regions: ['CN', 'AP', 'AM', 'EU'],
    game: 'iRacing',
    carClass: 'Formula',
    ...
    scoringRules_zh: '第1名25分，第2名18分，第3名15分，第4名12分，第5名10分，第6名8分，第7名6分，第8名4分，第9名2分，第10名1分',
    scoringRules_en: '1st 25pts, 2nd 18pts, 3rd 15pts, 4th 12pts, 5th 10pts, 6th 8pts, 7th 6pts, 8th 4pts, 9th 2pts, 10th 1pt',
    progressionRules_zh: '2站总积分最高者获得冠军',
    progressionRules_en: 'Highest total points across 2 rounds wins the championship.',
