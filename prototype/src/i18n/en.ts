export const en = {
  ...
  competition: {
    ...
    durationLaps: '{n} laps',
    advancementMetric: 'Advancement',
    advancementMetricPosition: 'Top {n}',
    advancementMetricLapTime: '107% / pole × {mult}',
    advancementMetricManual: 'Manual',
    eligibilityRoundRegistration: 'Open Registration',
    eligibilityPreviousStage: 'Previous Stage',
    eligibilityManualInvite: 'Invite Only',
  ...
  result: {
    ...
    statusLocked: 'Locked',
    showing: 'Provisional — editable & appealable',
    locked: 'Locked — final & scored',
